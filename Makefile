...
nixos-borgnix-system-x86_64-linux.tar.xz: borgnix.nix  common.nix  flake.lock  flake.nix
	rm -f result
	nix build .#borgnix
	cp --dereference --force result/tarball/nixos-system-x86_64-linux.tar.xz nixos-borgnix-system-x86_64-linux.tar.xz
...
nixos-syncnix-system-x86_64-linux.tar.xz: borgnix.nix  common.nix  flake.lock  flake.nix
	rm -f result
	nix build .#syncnix
	cp --dereference --force result/tarball/nixos-system-x86_64-linux.tar.xz nixos-syncnix-system-x86_64-linux.tar.xz
